...
export 'src/models/car_data.dart';
...
class FlutterCar extends StatefulWidget {
  ...
  static final FormFieldValidator<String> defaultPelakValidator = (value) {
    if (value.isEmpty || !Regex.pelak.hasMatch(value)) {
      return Translations.current.pelakNotvalid();
    }
    return null;
  };
...
class _FlutterCarState extends State<FlutterCar>
  ...
  Widget build(BuildContext context) {
    ...
    final pelakValidator =
        widget.pelakValidator ?? FlutterCar.defaultPelakValidator;
