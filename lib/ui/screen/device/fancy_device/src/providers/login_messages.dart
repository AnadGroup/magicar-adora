...
class LoginMessages with ChangeNotifier {
  LoginMessages({
    ...
    this.isActiveHint: defaultisActiveHint,
    this.deviceIdHint: defaultdeviceIdHint,
    this.serialNumberHint:defaultserialNumberHint,
    this.deviceStatusConstIdHint: defaultdeviceStatusConstIdHint,
    this.deviceTypeConstIdHint: defaultdeviceTypeConstIdHint,
  ...
  static const defaultdeviceIdHint = 'Device';
  static const defaultserialNumberHint = 'SerialNumber';
  static const defaultdeviceStatusConstIdHint = 'Device Status';
  static const defaultdeviceTypeConstIdHint = 'Device Type';
  static const defaultisActiveHint = 'Active';
...
/// Hint text of the password [TextField]
  ...
  final String serialNumberHint;
  ///final String passwordHint;
  final String deviceStatusConstIdHint;
  final String deviceTypeConstIdHint;
  final String isActiveHint;
