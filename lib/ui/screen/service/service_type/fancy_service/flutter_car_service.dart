...
export 'src/models/car_service_type_data.dart';
export 'src/providers/car_service_type_messages.dart';
...
class FlutterCar extends StatefulWidget {
  ...
  /// descriptions
  final CarServiceTypeMessages messages;
    ...
    return MultiProvider(
      providers: [
        ChangeNotifierProvider.value(
          value: widget.messages ?? CarServiceTypeMessages(),
        ),
        ChangeNotifierProvider.value(
              ...
              child: Theme(
                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    Positioned(
                      child: AuthCard(
                        regServiceTypeVM: widget.serviceTypeVM,
                        key: authCardKey,
