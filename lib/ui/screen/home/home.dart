                    ...
                    child: new GestureDetector(
                      ...
                      child: AvatarGlow(
                        ...
                        child: Material(
                          ...
                          child: CircleAvatar(
                            backgroundColor:
                                Colors.black12, //Colors.grey[100] ,
                            child: Image.asset(
  ...
  return FutureBuilder<bool>(
    ...
    builder: (context, snapshot) {
      if (snapshot.hasData && snapshot.data != null) {
        ...
        if (value) {
          if (_currentColorRow == Colors.black ||
              _currentColorRow == Colors.black38 ||
              _currentColorRow == Colors.black54) {
            _currentColorRow = Colors.white;
          }
        }
      }
                    ...
                    ? Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              margin:
                                  EdgeInsets.only(top: m_top, bottom: m_bot),
                              //color: Colors.white,
                              alignment: Alignment.center,
                              height: i_h,
                              width: i_w,
