...
class FlutterRegister extends StatefulWidget {
  FlutterRegister({
    Key key,
    @required this.onlyRegister,
  ...
  static final FormFieldValidator<String> defaultEmailValidator = (value) {
    if (value.isEmpty || !Regex.email.hasMatch(value)) {
      return Translations.current.pleaseEnterMobile();
    }
    return null;
  };
  ...
  @override
  _FlutterRegisterState createState() => _FlutterRegisterState();
}

class _FlutterRegisterState extends State<FlutterRegister>
  ...
  Widget build(BuildContext context) {
    ...
    final emailValidator =
        widget.emailValidator ?? FlutterRegister.defaultEmailValidator;
    final passwordValidator =
        widget.passwordValidator ?? FlutterRegister.defaultPasswordValidator;
    final mobileValidator=widget.mobileValidator ?? FlutterRegister.defaultMobileValidator;
    final bool isSignUpDefault=widget.isSignUp ?? false ;
