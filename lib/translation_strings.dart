...
class Translations {
  ...
  String withFinger() => Intl.message('Enter with Finger Print',
      name: 'withFinger', desc: 'withFinger');

  String withPassword() => Intl.message('Enter with Password',
      name: 'withPassword', desc: 'withPassword');

  String withPattern() => Intl.message('Enter with Pattern',
  ...
  String local() =>
      Intl.message('Language', name: 'local', desc: 'local');
}
