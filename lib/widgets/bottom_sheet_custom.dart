...
const Duration _kBottomSheetDuration = Duration(milliseconds: 50);
const double _kMinFlingVelocity = 40.0;
...
class _ModalBottomSheetLayout extends SingleChildLayoutDelegate {
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    return BoxConstraints(
      ...
      minHeight: 0.0,
      maxHeight: (maxHeight!=null && maxHeight>0) ? constraints.maxHeight * maxHeight : constraints.maxHeight*0.8,
    );
  }
...
class _ModalBottomSheet<T> extends StatefulWidget {
  const _ModalBottomSheet({ Key key, this.route,this.mHeight }) : super(key: key);
          ...
          return Semantics(
            ...
            child: ClipRect(
              child: CustomSingleChildLayout(
                delegate: _ModalBottomSheetLayout(animationValue,widget.mHeight),
                child: BottomSheet(
...
class _ModalBottomSheetRoute<T> extends PopupRoute<T> {
  ...
  Widget buildPage(BuildContext context, Animation<double> animation, Animation<double> secondaryAnimation) {
    ...
    Widget bottomSheet = MediaQuery.removePadding(
      context: context,
      removeTop: true,
      child: _ModalBottomSheet<T>(route: this,mHeight: mHeight,),
    );
    if (theme != null)
